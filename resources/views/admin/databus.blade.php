                    ...
                    <table id="example0" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#editbus" title="edit data" data-nama="{{ $databus->nama }}" data-id="{{ $databus->id_tipebus }}" data-tipe="{{ $databus->tipebus }}" data-kursi="{{ $databus->jumlah_kursi }}" data-desc="{{ $databus->deskripsi }}"><i class="fas fa-pencil-alt"></i></button>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $tipe->nama }}</td>
                          <td>
                            <button class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#edittipe" title="edit data" data-id="{{ $tipe->id }}" data-tipe="{{ $tipe->nama }}"><i class="fas fa-pencil-alt"></i></button>
                            <button class="btn btn-outline-danger btn-sm" title="hapus data" href="managemen-bus/delete-tipe-bus/{{$tipe->id}}" onclick="hapus()" id="del_data"><i class="fas fa-trash"></i></button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
                    ...
                    <table id="example3" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $rutes->rute }}</td>
                          <td>
                            <button class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#editrute" title="edit data" data-id="{{ $rutes->id }}" data-rute="{{ $rutes->rute }}"><i class="fas fa-pencil-alt"></i></button>
                            <button class="btn btn-outline-danger btn-sm" title="hapus data" href="managemen-bus/delete-rute/{{$rutes->id}}" onclick="hapus()" id="del_data"><i class="fas fa-trash"></i></button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
